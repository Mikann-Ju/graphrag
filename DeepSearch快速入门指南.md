...
drift_search:
  ...
  # 📎 提示文件参考 (点击查看详细内容):
  # 系统提示文件: [drift_search_system_prompt.txt](./prompts/drift_search_system_prompt.txt)
  # 汇总提示文件: [drift_search_reduce_prompt.txt](./prompts/drift_search_reduce_prompt.txt)
